...
exports.register = function (server, options, next) {
    ...
    server.route([
       ...
       // {method: 'POST',   path: '/users/{username}/folders/{folderName}/{crsId}', config: Controllers.User.addCourseToFolder},
        ...
        {method: 'GET',    path: '/courses/{id}/homepage',          config: Controllers.Course.getHomepage},
        ...
        {method: 'GET',    path: '/courses/{id}/news',              config: Controllers.Course.getNews},
        ...
        {method: 'POST',   path: '/courses/{id}/homepage',          config: Controllers.Course.postHomepage},
